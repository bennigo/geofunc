...
def platePoles(plate, units="ry", reference="ITRF2008"):
    """
    ...
    elif reference == "ITRF2014":
        # ITRIF2014 Absolute Plate rotation poles From Table 1
        # from altamimi etal2017 10.1093/gji/ggx136
        poles = np.array(
            [
                [-0.085, -0.531, 0.770],
                [0.024, -0.694, -0.063],
